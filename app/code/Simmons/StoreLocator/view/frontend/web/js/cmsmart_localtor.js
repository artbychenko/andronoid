define([
    'jquery',
    'Simmons_StoreLocator/js/localtor_init',
    'localtor_creator',
    'jquery/ui'
], function($, init, creator) {
    return function (config, requestedLocation) {
        $(document).ready(function() {
            ...
            map.setCenter(requestedLocation);
            ...
            $.each(storeListData,function(key, item) {
                var marker = createMarker(key, item);
            });
            ...
            */
            ...
            function createMarker(key, store) {
